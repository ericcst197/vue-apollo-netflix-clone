        ...
        <div class="max-w-[978px] mx-auto pt-5 pb-14 px-8">
            <form>
                <div class="max-w-[440px] mx-auto mt-6 mb-5 text-start">
                    ...
                    <p class="text-[18px] leading-tight">Just add a password and you're done!
                        We hate paperwork, too.</p>
                    <BaseInput id="signup-email" label="Email Address" type="email" v-model="email" class="max-w-[24rem]"
